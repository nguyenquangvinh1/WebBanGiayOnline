    ...
    public partial class datn : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("16658c0f-d4ca-46c0-bd31-1646dbc27504"), "TTNH", "Thanh toán khi nhận hàng" },
                    { new Guid("77d63e76-4a5a-423c-bb91-a4c6e28bd701"), "ALL", "Cả 2" },
                    { new Guid("7d0dd88a-208e-4b87-8599-53e2d675e952"), "VNPAY", "Thanh toán VNPAY" },
                    { new Guid("9163909b-815e-420c-9f5a-0af6239d74dd"), "CK", "Chuyển khoản" },
                    { new Guid("a7e9dd50-c591-4306-87a7-8e847b2dc441"), "TTM", "Tiền mặt" },
                    { new Guid("e4b4be0b-0786-4e2e-be1c-5697403e7779"), "MoMo", "Thanh toán MoMo" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("71e58225-a611-4788-a915-8128673d5d52"), null, new DateTime(2025, 5, 27, 15, 46, 42, 362, DateTimeKind.Local).AddTicks(3384), "Admin", 1 },
                    { new Guid("7f448c31-714e-4326-8abc-69ccbe132f2b"), null, new DateTime(2025, 5, 27, 15, 46, 42, 362, DateTimeKind.Local).AddTicks(3413), "Nhân Viên", 1 },
                    { new Guid("b812ab68-d553-41a4-ab1c-6c42da80aeac"), null, new DateTime(2025, 5, 27, 15, 46, 42, 362, DateTimeKind.Local).AddTicks(3416), "Khách hàng", 1 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("0bef1c56-cc50-4e7a-b320-14e9dabe966b"), null, null, new Guid("71e58225-a611-4788-a915-8128673d5d52"), "123456789012", "admin_tong@fpt.edu.vn", 1, "admin_tong.png", "Admin Tổng", "ADMIN01", new DateTime(1980, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, new DateTime(2025, 5, 27, 15, 46, 42, 362, DateTimeKind.Local).AddTicks(3618), "Admin123", "0123456789", 1, "admin_tong" });
