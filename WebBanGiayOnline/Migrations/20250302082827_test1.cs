    ...
    public partial class test1 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("3bbe81b6-40db-4d81-b8b1-c0ff4054b5eb"), null, new DateTime(2025, 3, 2, 15, 28, 24, 809, DateTimeKind.Local).AddTicks(8027), "Nhân Viên", 1 },
                    { new Guid("c2d3cc98-fbe9-4a52-a340-8a902d1f9ada"), null, new DateTime(2025, 3, 2, 15, 28, 24, 809, DateTimeKind.Local).AddTicks(8015), "Admin", 1 },
                    { new Guid("dc683558-b784-4b9f-ab2e-bb925795da7b"), null, new DateTime(2025, 3, 2, 15, 28, 24, 809, DateTimeKind.Local).AddTicks(8029), "Khách Hàng", 1 }
                });
