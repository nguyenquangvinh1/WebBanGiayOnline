        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Ngay_them = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("1dcdb41f-67d4-496a-a274-eb9adc7abc0a"), null, new DateTime(2025, 2, 10, 18, 38, 41, 540, DateTimeKind.Local).AddTicks(7114), "Nhân Viên", 1 },
                    { new Guid("8aca46ec-c23e-4eba-910e-5b8ce385f1d5"), null, new DateTime(2025, 2, 10, 18, 38, 41, 540, DateTimeKind.Local).AddTicks(7086), "Admin", 1 },
                    { new Guid("d56359c4-8309-487e-bab9-f73134194335"), null, new DateTime(2025, 2, 10, 18, 38, 41, 540, DateTimeKind.Local).AddTicks(7116), "Khách Hàng", 1 }
                });
